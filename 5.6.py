...
# с фирмами и их прибылями, а также словарь со средней прибылью. Если фирма получила убытки,
...
prof_aver = 0
i = 0
with open('file_firm.txt', 'r') as file:
    for line in file:
...
with open('file_firm.json', 'w') as write_js:
